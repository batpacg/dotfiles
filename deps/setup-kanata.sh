...
# https://github.com/jtroo/kanata/discussions/130#discussioncomment-14593559
# it is necessary to add the uinput group as a system group in newer versions
# of systemd.
groupadd --system "$UINPUT_GROUP" || echoinfo "Group '$UINPUT_GROUP' likely already exists."
...
# kanata-bin from arch aur preferred.
